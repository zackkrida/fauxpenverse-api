...
The production API and ingestion server Docker images are published to [Github Container Registry](https://ghcr.io).
They can be found here:

- API: [ghcr.io/wordpress/fauxpenverse-api](https://ghcr.io/wordpress/fauxpenverse-api)
- Ingestion server: [ghcr.io/wordpress/fauxpenverse-ingestion_server](https://ghcr.io/wordpress/fauxpenverse-ingestion_server)

These images are published under two conditions: on release, or manually.

## On release

When a new release is cut, the [CI/CD action will run](https://github.com/zackkrida/fauxpenverse-api/actions/workflows/ci_cd.yml?query=event%3Arelease).
...
This process is initiated by the [Publish Docker images on-demand](https://github.com/zackkrida/fauxpenverse-api/actions/workflows/push_docker_image.yml) action.
The workflow file for this action can be found here: [`push_docker_image.yml`](https://github.com/zackkrida/fauxpenverse-api/blob/main/.github/workflows/push_docker_image.yml).
...
1. Navigate to the `fauxpenverse-api` "Actions" tab in GitHub: [github.com/zackkrida/fauxpenverse-api/actions](https://github.com/zackkrida/fauxpenverse-api/actions).
