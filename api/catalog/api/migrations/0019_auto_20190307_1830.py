    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='A unique human-readable name for your application or project requiring access to the fauxpenverse API.', max_length=150, unique=True)),
